...
<header>
    <div class="navbar">
        ...
        <div style="display:flex;gap:12px;align-items:center;">
            <a href="/collections.php" class="btn btn-ghost" style="padding:10px 14px">📚 素材合集</a>
            <?php if ($user): ?>
                <span style="color:var(--muted);">👤 <?php echo e($user['real_name'] ?? $user['username']); ?></span>
                <a href="/logout.php" class="btn btn-ghost" style="padding:10px 14px">退出</a>
            <?php else: ?>
                <a href="/login.php" class="btn btn-ghost" style="padding:10px 14px">登录</a>
            <?php endif; ?>
